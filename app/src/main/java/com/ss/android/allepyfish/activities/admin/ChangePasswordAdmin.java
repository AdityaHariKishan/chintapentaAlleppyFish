...
public class ChangePasswordAdmin extends AppCompatActivity {
    ...
    private static final String TAG = "ChangePasswordAdmin";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fpEmailIdEdt = (EditText)findViewById(R.id.fpEmailIdEdtAdmin);
        fpEmailIdEdt.setEnabled(false);
        fpEmailIdEdt.setText(myMailIdPWD);
        fpPasswordEdt = (EditText)findViewById(R.id.fpPasswordEdtAdmin);

        submmitPasswordBtn = (Button)findViewById(R.id.submmitPasswordBtnAdmin);
...
//        showDialog();
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                AppConfig.UPDATE_USER_REQUESTS, new Response.Listener<String>() {
...
//                hideDialog();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("user_email", myMailIdPWD);
                params.put("responded_by", userName);
                return params;
            }
        };
