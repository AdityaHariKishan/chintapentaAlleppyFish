...
public class AdminRequestsAdapter extends BaseAdapter {
    ...
    public AdminRequestsAdapter(Context context, ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        // Declare Variables
        TextView requestedMailId;
        TextView requestSubjectTxt;
        TextView requestReasonTxt;
        ...
        View itemView = inflater.inflate(R.layout.admin_requests_adapters, parent, false);
        // Get the position
        resultp = data.get(position);

        // Locate the TextViews in listview_item.xml
        requestedMailId = (TextView) itemView.findViewById(R.id.requestedMailId);
        requestSubjectTxt = (TextView) itemView.findViewById(R.id.requestSubjectTxt);
        requestReasonTxt = (TextView) itemView.findViewById(R.id.requestReasonTxt);
...
//        contact.put("login_type", login_type);
        ...
        requestedMailId.setText(resultp.get("user_email"));
        requestSubjectTxt.setText(resultp.get("request_subject"));
        requestReasonTxt.setText(resultp.get("request_reason"));
