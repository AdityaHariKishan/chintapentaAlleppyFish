...
public class ManagerUploads extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manager_uploads);
        ...
        new getMyUploads().execute();

    }

    private class getMyUploads extends AsyncTask<Void, Void, Void> {
...
//
//            }
            BoysInfoAdapter sfa = new BoysInfoAdapter(ManagerUploads.this, contactList);
            lv.setAdapter(sfa);
