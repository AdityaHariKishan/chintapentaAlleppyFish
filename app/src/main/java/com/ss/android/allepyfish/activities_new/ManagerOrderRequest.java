        ...
        if (!(dealCityStr.length() == 0)) {
            if (qtyStr.equals(".")) {
                ...
                if ((qtyStr.length() == 0)) {
                    ...
                    float val2 = Float.parseFloat(qtyStr);
                    ...
                    if(!(val2 < 1)) {
                        ...
                        if(!(val2 > 10000)) {
                            ...
                            inputQuantity.setError("Maximum Quantity Exceeded Should be lessthan 10000");
                        }
                    }
                    else {
                        inputQuantity.setError("Minimum Quantity Should be 1 kg");
                    }
